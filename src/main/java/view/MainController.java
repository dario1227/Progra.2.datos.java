...
public class MainController implements Initializable {
    ...
    private Animation volumeShowAnimation =
            new Transition() {
                {
    ...
    private Animation volumeHideAnimation =
            new Transition() {
                {
                    setCycleDuration(Duration.millis(250));
                    setInterpolator(Interpolator.EASE_BOTH);
    ...
    private Animation searchShowAnimation =
            new Transition() {
                {
                    setCycleDuration(Duration.millis(250));
                    setInterpolator(Interpolator.EASE_BOTH);
    ...
    private Animation searchHideAnimation =
            new Transition() {
                {
                    setCycleDuration(Duration.millis(250));
                    setInterpolator(Interpolator.EASE_BOTH);
    ...
    private Animation unloadViewAnimation =
            new Transition() {
                {
                    setCycleDuration(Duration.millis(250));
                    setInterpolator(Interpolator.EASE_BOTH);
    ...
    private Animation loadLettersAnimation =
            new Transition() {
                {
                    setCycleDuration(Duration.millis(250));
                    setInterpolator(Interpolator.EASE_BOTH);
    ...
    private Animation unloadLettersAnimation =
            new Transition() {
                {
                    setCycleDuration(Duration.millis(250));
                    setInterpolator(Interpolator.EASE_BOTH);
    ...
    private Animation newPlaylistAnimation =
            new Transition() {
                {
    ...
    public void initialize (URL location, ResourceBundle resources) {
        ...
        frontSliderTrack
                ...
                .bind(
                        timeSlider
                                .widthProperty()
                                .multiply(timeSlider.valueProperty().divide(timeSlider.maxProperty())));
                        ...
                        (observable, oldText, newText) -> {
                            ...
                            if (text.equals("")) {
                                if (searchPopup.isShowing()
                                            && ! searchHideAnimation.getStatus().equals(Status.RUNNING)) {
        ...
        Search.hasResultsProperty()
              .addListener(
                      (observable, hadResults, hasResults) -> {
                          if (hasResults) {
    ...
    private void createVolumePopup () {
        try {
            ...
            FXMLLoader loader =
                    new FXMLLoader(this.getClass().getResource(Resources.FXML + "VolumePopup.fxml"));
    ...
    private void initializePlaylists () {
        for (Playlist playlist : Library.getPlaylists()) {
            try {
                FXMLLoader loader =
                        new FXMLLoader(this.getClass().getResource(Resources.FXML + "PlaylistCell.fxml"));
                                        ...
                                        switch (dragString) {
                                            ...
                                            case "List":
                                                ObservableList<Song> songs =
                                                        (ObservableList<Song>) OdysseyPlayer.getDraggedItem();
                                                for (Song s : songs) {
    ...
    private void navigateToCurrentSong () {
        ...
        Album album =
                artist
                        .getAlbums()
                        .stream()
                        .filter(x -> x.getTitle().equals(song.getAlbum()))
                        .findFirst()
                        .get();
                                ...
                                cell.setOnMouseClicked(
                                        event -> {
                                            ...
                                            ArtistsMainController artistsMainController =
                                                    (ArtistsMainController) loadView("ArtistsMain");
                                            artistsMainController.selectArtist(artist);
                                            searchBox.setText("");
                                            sideBar.requestFocus();
                                        });
