...
import view.ImportMusicDialogController;
import view.MainController;
import view.NowPlayingController;
...
public class OdysseyPlayer extends Application {
    ...
    // This will then be compared to the number of files in the music directory when starting up the
    // application to
    ...
    // This is important when adding new songs after others have been deleted because the last id
    // assigned
    ...
    private static void checkLibraryXML () {
        ...
        if (libraryXML.exists()) {
            ...
            try {
                ...
                xmlFileNum = xmlMusicDirFileNumFinder();
                // Gets music directory path from xml file so that it can be passed as an argument when
    ...
    public void start (Stage stage) {
        ...
        try {
            ...
            // Calls the function to check in the library.xml file exists. If it does not, the file is
            // created.
            checkLibraryXML();
        } catch (Exception ex) {
            ex.printStackTrace();
